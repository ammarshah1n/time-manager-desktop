...
// OnboardingUserPrefs is now in Sources/TimedKit/Core/Services/OnboardingUserPrefs.swift —
// extracted so EmailSyncService can read it on iOS where this view file is gated.
