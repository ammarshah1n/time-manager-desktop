...
// Settings: email accounts, sync, time blocks, notifications, appearance.
...
struct PrefsPane: View {
    ...
    enum PrefTab { case accounts, sync, blocks, notifications, appearance }
}
...
struct SyncTab: View {
    @State private var frequency = 1   // index into options
    @State private var syncOnLaunch = true
    @State private var fetchAttachments = false
...
struct BlocksTab: View {
    @State private var defaultMins: Double = 60
    @State private var autoBlock = false
    @State private var bufferMins: Double = 10
...
struct NotificationsTab: View {
    ...
    @State private var blockStart      = true
...
struct AppearanceTab: View {
    @State private var theme = 0   // 0=system 1=light 2=dark
    @State private var accent = 0  // 0=blue 1=crimson 2=indigo
