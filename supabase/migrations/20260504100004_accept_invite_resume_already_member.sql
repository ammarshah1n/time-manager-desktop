-- 20260504100004_accept_workspace_invite_already_member.sql
-- Preserve race-safe consumed-invite classification while allowing the same
-- profile to resume an already-accepted invite and receive already_member=true.
